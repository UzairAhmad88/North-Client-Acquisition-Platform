# Inventory Policies & Probabilistic Optimization

## Executive Summary
Dynamic safety stock calculation, Economic Order Quantity (EOQ), reorder point modeling, and holding cost minimization.
