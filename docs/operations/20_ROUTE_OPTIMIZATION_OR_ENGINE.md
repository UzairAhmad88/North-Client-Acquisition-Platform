# Route Optimization & Operations Research Engine

## Executive Summary
Vehicle Routing Problem (VRP) solving with time windows, capacity constraints, carbon emissions, and driver rest mandates.
