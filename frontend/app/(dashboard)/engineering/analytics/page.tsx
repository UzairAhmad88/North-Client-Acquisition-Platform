    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 p-6 space-y-6">
      <div className="flex items-center justify-between border-b border-slate-800 pb-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Deployment frequency, lead time, change failure rate, and MTTR trend analytics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-slate-900/80 border border-slate-800 rounded-xl p-6 space-y-4">
          ...
          <div className="bg-slate-950 p-4 rounded-lg border border-slate-800 space-y-2 text-xs font-mono text-slate-300">
            <div className="text-indigo-300 font-bold uppercase">&gt; Active Component: DORA & Engineering Analytics</div>
