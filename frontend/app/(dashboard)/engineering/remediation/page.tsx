      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            Controlled Self-Healing Remediation
          ...
          <p className="text-sm text-slate-400 mt-1">Policy-governed automated remediation execution subject to human gatekeeper approval.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-slate-900/80 border border-slate-800 rounded-xl p-6 space-y-4">
          ...
          <div className="bg-slate-950 p-4 rounded-lg border border-slate-800 space-y-2 text-xs font-mono text-slate-300">
            <div className="text-indigo-300 font-bold uppercase">&gt; Active Component: Controlled Self-Healing Remediation</div>
