...
export const metadata = {
  title: 'Planetary Chaos Engineering | Uzaii Global Infrastructure',
  description: 'Controlled packet loss, latency spikes, and AZ blackhole fault injection.',
};
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-xs text-slate-500 font-mono">
          Route: /global-infrastructure/chaos
        </div>
      </div>
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Planetary Chaos Engineering</h1>
            <p className="text-xs text-slate-400">Controlled packet loss, latency spikes, and AZ blackhole fault injection.</p>
          </div>
        </div>
      </div>
