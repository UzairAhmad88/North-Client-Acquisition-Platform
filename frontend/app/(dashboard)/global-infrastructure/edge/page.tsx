...
export const metadata = {
  title: 'Distributed Edge Computing | Uzaii Global Infrastructure',
  description: 'Metro edge locations, micro-K8s worker nodes, and sub-10ms user experiences.',
};
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-xs text-slate-500 font-mono">
          Route: /global-infrastructure/edge
        </div>
      </div>
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Distributed Edge Computing</h1>
            <p className="text-xs text-slate-400">Metro edge locations, micro-K8s worker nodes, and sub-10ms user experiences.</p>
          </div>
        </div>
      </div>
