...
export const metadata = {
  title: 'Global Traffic Management | Uzaii Global Infrastructure',
  description: 'Planetary ingress telemetry, requests per second, and continent distribution.',
};
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-xs text-slate-500 font-mono">
          Route: /global-infrastructure/traffic
        </div>
      </div>
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Global Traffic Management</h1>
            <p className="text-xs text-slate-400">Planetary ingress telemetry, requests per second, and continent distribution.</p>
          </div>
        </div>
      </div>
