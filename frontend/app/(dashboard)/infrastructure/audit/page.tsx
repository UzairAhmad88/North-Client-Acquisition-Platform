...
export const metadata = {
  title: 'Infrastructure Audit Trail | Uzaii Cloud OS',
  description: 'Tamper-evident log of all infrastructure modifications and agent operations.',
};
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Infrastructure Audit Trail</h1>
            <p className="text-xs text-slate-400">Tamper-evident log of all infrastructure modifications and agent operations.</p>
          </div>
        </div>
      </div>
