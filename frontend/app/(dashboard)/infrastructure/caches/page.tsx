...
export const metadata = {
  title: 'Cache Infrastructure | Uzaii Cloud OS',
  description: 'Redis and Memcached clusters, hit rates, eviction policies, and memory sizing.',
};
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Cache Infrastructure</h1>
            <p className="text-xs text-slate-400">Redis and Memcached clusters, hit rates, eviction policies, and memory sizing.</p>
          </div>
        </div>
      </div>
