...
export const metadata = {
  title: 'Capacity Planning | Uzaii Cloud OS',
  description: 'Current capacity, reserved instances, available headroom, and exhaustion risk.',
};
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Current capacity, reserved instances, available headroom, and exhaustion risk.</p>
          </div>
        </div>
      </div>
