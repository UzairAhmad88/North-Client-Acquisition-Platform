...
export const metadata = {
  title: 'Cloud Cost Management | Uzaii Cloud OS',
  description: 'Attributable spend by business unit, project, service, and cost center.',
};
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Cloud Cost Management</h1>
            <p className="text-xs text-slate-400">Attributable spend by business unit, project, service, and cost center.</p>
          </div>
        </div>
      </div>
