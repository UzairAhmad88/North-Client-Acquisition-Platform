...
export const metadata = {
  title: 'DNS Management | Uzaii Cloud OS',
  description: 'Zone administration, TTL optimization, health checks, and global traffic routing.',
};
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Zone administration, TTL optimization, health checks, and global traffic routing.</p>
          </div>
        </div>
      </div>
