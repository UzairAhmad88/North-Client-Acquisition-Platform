...
export const metadata = {
  title: 'Drift Detection | Uzaii Cloud OS',
  description: 'Continuous reconciliation of real cloud resources against declared IaC states.',
};
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Continuous reconciliation of real cloud resources against declared IaC states.</p>
          </div>
        </div>
      </div>
