...
export const metadata = {
  title: 'Infrastructure Incidents | Uzaii Cloud OS',
  description: 'Automated detection, triage, blast-radius containment, and remediation.',
};
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Infrastructure Incidents</h1>
            <p className="text-xs text-slate-400">Automated detection, triage, blast-radius containment, and remediation.</p>
          </div>
        </div>
      </div>
