...
export const metadata = {
  title: 'Infrastructure Observability | Uzaii Cloud OS',
  description: 'Unified logs, metrics, traces, and health telemetry from all cloud assets.',
};
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Infrastructure Observability</h1>
            <p className="text-xs text-slate-400">Unified logs, metrics, traces, and health telemetry from all cloud assets.</p>
          </div>
        </div>
      </div>
