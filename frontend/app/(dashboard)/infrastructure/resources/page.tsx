...
export const metadata = {
  title: 'Resource Inventory | Uzaii Cloud OS',
  description: 'Continuous asset cataloging with owner attribution and lifecycle state.',
};
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-xs text-slate-500 font-mono">
          Route: /infrastructure/resources
        </div>
      </div>
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Continuous asset cataloging with owner attribution and lifecycle state.</p>
          </div>
        </div>
      </div>
